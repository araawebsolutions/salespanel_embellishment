...
<div class="row">
<div class="col-xs-3 col-sm-3 m-t-t-10">
...
<b>CO:</b> Customer Original Uploaded. <b>SP:</b> Soft Proof Uploaded. <b>CA:</b> Customer Approval Received. <b>PF:</b> Print Files Uploaded</span>
...
<mark class="yellow-badge-aert">R =  <span id="customer_r"></span> | S =  <span id="customer_r"></span> </mark>
<mark class="blue-badge-aert">R =  <span id="checklist_r"></span> | S =  <span id="checklist_r"></span></mark>
</div>
...
<div class="btn-group dropdown row" style="    margin-left: 15px;margin-top: 20px;">
    <div class="col-md-1"><a href="<?=main_url?>Artworks/history" type="" class="btn btn-outline-dark waves-light waves-effect button-adjts-info artwork-more-btn">Artwork History</a></div>
    <div class="col-md-1" style="    margin-left: 15px;"><a href="<?=main_url?>Artworks/advancesearch" type="" class="btn btn-outline-dark waves-light waves-effect button-adjts-info artwork-more-btn" >Advance Reporting</a></div>
</div>
...
<th class="no-border">Messages/Alerts</th>
...
<? include('ajax/fetch_rejected_artworks.php'); ?>
</tbody>
</table>
</div>
</div>
...
<script>
  ...
  /*function rejectedArtwork(){
	$.ajax({
		type: "post",
		url: mainUrl+"Artworks/fetch_rejectedartworks_jobs",
		cache: false,               
		data:{},
		dataType: 'html',
