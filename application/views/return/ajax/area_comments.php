...
<div class="modal-body p-t-0">
    <div class="panel-body">
        ...
        <p class="message-field-title">Area Responsible Notes:</p>
        <div class="col-12 no-padding">
            <textarea class="form-control blue-text-field" rows="5" id="new-comment" readonly><?php echo $data[0]['ac_area_resp_c']; ?></textarea>
        </div>
