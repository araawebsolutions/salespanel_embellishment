            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                       ...
                       <!-- <form method="post" id="" class="labels-form " enctype="multipart/form-data" action="<?= main_url ?>tickets/addTickets/addpix">
                        ...
                        <button type="submit">go</button>
                         ...
                         <?php if(!@$_GET['form']){ ?>
                        <form method="post" id="byOrderNum" class="labels-form" enctype="multipart/form-data" action="<?= main_url ?>tickets/addTickets/findOrders">
