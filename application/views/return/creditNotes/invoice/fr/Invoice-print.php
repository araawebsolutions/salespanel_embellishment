    ...
    <td colspan="3" align="left" valign="top" style="border:#CCCCCC 1px solid; padding-bottom:10px;"><table width="730px;" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed">
        ...
        <tr>
          ...
          <td class="invoicetable_description_loop">
		        <?
				if($OrderDetails[$i]->ProductID == 0){
				 echo $this->orderModel->ReplaceHtmlToString_($OrderDetails[$i]->ProductName);
				}else{
   ...
   <? } ?>
        ...
        <tr>
         ...
         <?  echo $symbol."".(number_format($price*$exchange_rate,2));?>
		  ...
		  <?php $print_qty =  $OrderDetails[$i]->Print_Qty; ?>
          <?  echo $symbol."".(number_format($print_qty*$exchange_rate,2));?>
          </td>
  ...
  <? 
   ...
   <? } ?>    
       ...
       <? if($discount > 0){?> 
        ...
        <tr>
          <td colspan="2">&nbsp;</td>
          <td colspan="2"  class="invuice_subtotal">Sous total:</td>
          <td class="invuice_subtotal_price">
            <?php
                  if($OrderInfo[0]->PaymentMethods=='SampleOrder'){
					 $SubTotal ='0.00';
        ...
        <tr>
          <td colspan="2">&nbsp;</td>
          <td colspan="2"  class="invuice_subtotal">TVA @ (20.00)%</td>
          <td class="invuice_subtotal_price">
                <?
	  ...
	  ?>
       ...
       <tr>
          <td colspan="2">&nbsp;</td>
          <td colspan="2" class="invuice_subtotal"><b>somme finale:</b></td>
