...
?>
  ...
  <tr>
    <td class="invoicetable_bgBlue" width="25%">PRODUITS</td>
    <td class="invoicetable_bgBlue" width="50%">La description</td>
    <td class="invoicetable_bgBlue" width="20%">Etiquettes</td>
    <td class="invoicetable_bgBlue" width="25%">Quantite</td>
    <td class="invoicetable_bgBlue" width="15%">HT.vat</td>
  </tr>
      ...
      if(preg_match($regex, $prodinfo['ProductBrand'], $match)){
        $format =($AccountDetail->Quantity > 1)?'Rouleaux':'Rouleau';
      }    
  ...
  <tr>
    ...
    <td align="center" class="invoicetable_tabel_border">
      ...
      <?php } else{?>
      <?=$AccountDetail->Quantity.' '.$format?><br>
                 <?=$Total_labels.' '.$lbss?>
      <?php }?>
    </td>
    <td align="center" class="invoicetable_tabel_border">
...
<? if($AccountDetail->Printing =="Y" && $AccountDetail->regmark !="Y"){?>
  <tr <?=$stylo?>>
    ...
    <td class="invoicetable_tabel_border" align="center">
      <?php echo $AccountDetail->Print_Qty; ?>&nbsp;<?php echo ($AccountDetail->Print_Qty > 1)?"Dessins":"Dessin"; ?>
      <br>
      <?php if(!preg_match($regex, $prodinfo['ProductBrand'], $match)){?>
      
        (<?php echo $AccountDetail->Free; ?>&nbsp; <?php echo ($AccountDetail->Free > 1)?"Dessins":"Dessin"; ?> Free)
   ...
   <?
    ...
    <?php 
        ...
        include(APPPATH . 'views/order_quotation/quotation/fr/pp_line_fr.php');
...
<? }?>
 ...
 <tr>
  ...
  <td colspan="3" class="invoicetable_tabel_border"> </td>
   <td colspan="1" class="invoicetable_tabel_border" align="center"><b>Total de ligne</b></td>
  <td class="invoicetable_tabel_border" align="center">
  <?
