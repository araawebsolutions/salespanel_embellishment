            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped" id="tabhidden">
                    ...
                    <tr class="card-heading-title">
                        <th class="text-center invoice-heading-text" width="2%"></th>
                        <th class="text-center invoice-heading-text" width="10%">Manufacturer ID</th>
                        <th class="text-center invoice-heading-text" width="40%">Description</th>
                        ...
                        <th class="text-center invoice-heading-text" width="10%">Ext.VAT</th>
              ...
              <td><?php if(preg_match("/Roll Labels/i",$record->ProductBrand)) {?>
                ...
                if($record->Printing=="Y" and $record->regmark != 'Y'){
                 echo $prodName =  $ci->orderModal->Printed_desc($record->wound,$record->Print_Type,$record->ProductCategoryName,$record->orientation,$record->FinishType);
	              ...
	              echo $prodName =  $ci->orderModal->customize_product_name($record->is_custom,$record->ProductCategoryName,$record->LabelsPerRoll,
		($record->orignalQty /$record->Quantity),$reordercode,$record->ManufactureID,$record->ProductBrand,$record->wound,$record->OrderData,$passvalue);
               }
          ...
          <tr>
            ...
            <td colspan="5" class="text-center"><strong id="sub_total">
