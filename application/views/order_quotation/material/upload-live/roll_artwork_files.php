    ...
    <tr class="upload_row custom_artwork" >
      ...
      <td width="">
        <input class="form-control " id="no_design_pop" onchange="show_des_btn('this')"  placeholder="Enter No Designs" type="number">
					 ...
					 <td width="" class="text-center">
						 <input value="" id="no_of_roll_custom_art" onchange="$('#custom_qty_roll_<?=$ProductID?>').val($(this).val());show_des_btn('this') "; class="form-control input-number text-center allownumeric input_rolls" type="number">
						 <!--<label class="quantity_labels" style="font-size: 8px; padding: 0; margin: 0;" >Min Roll <?=$minroll?></label>-->
					 </td>
					 
				
					 
					 <td width="" align="center">
						 <button data-value="no_design_btn_up" class=" btn btn-success save_artwork_file_roll_custom" style="padding: 8px;"> <i class="fa fa-save"></i></button>
