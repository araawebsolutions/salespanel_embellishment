  ...
  <tbody>
	...
	$remaingsheets = $total;
	  ...
	  <tr class="upload_row">
		  ...
		  <td width="" class="text-center"><input type="number" data-placement="top" data-toggle="popover" data-content="" value="<?=($unitqty=='Labels')?$row->labels:$row->qty?>" 
                            class="form-control labels_input allownumeric"  /></td>
		  ...
		  <td width="" class="text-center" class="text-center" >
			  ...
			  <button style="display:none;" data-id="<?=$row->ID?>" title="Update artwork details" class="sheet_updater  btn btn-success" > <i class="fa f-10 fa-save "></i> </button>
				
			  <button data-value="sheets" id="<?=$row->ID?>" title="Delete Artwork" class="delete_artwork_file  btn btn-danger" style="padding: 8px;background-color: gray; border: 1px solid gray;" > <i class="fa f-10 fa-trash "></i> </button></td>
	  </tr>
    <? } 
	  ...
	  <tr class="upload_row uploadsavesection" style=" <?=(count($files)>0)?'display:none':''?>">
		  ...
		  <td width=""><input class="form-control labels_input allownumeric ints"  
                            placeholder="Enter <?=$sheets_text?>" value=""  type="number"></td>
		  <td width="" align="center" style="vertical-align:middle;" class="text-center displaysheets">&nbsp;</td>
		  <td width="" align="center">
			  <button data-value="sheets" class=" btn btn-success save_artwork_file" style="padding: 8px;"> <i class="fa fa-save"></i></button>
			 
			  
			  <button data-value="sheets" title="Delete Artwork" class="hide_another_art  btn btn-success"  style="padding: 8px;background-color: gray; border: 1px solid gray;">
	  ...
	  <tr id="upload_progress" style="display:none;">
		  <td colspan="4"><div id="progressbar" class="col-md-11"></div></td>
    ...
    <? } ?>
    <tr>
      <td width="40%" colspan="3" class="text-left" style="vertical-align:middle;"></td>
      <td width="30%" class="text-center" style="vertical-align:middle; text-align:left;"><p class="total_user_sheet">
          <?=$total_sheets*$multiplyfactor?>
        </p></td>
      <td  align="center" style="vertical-align:middle;" class="text-center"><p class="total_user_labels">
          <?=$total_labels/$multiplyfactor?>
        </p></td>
      <td align="center" class="text-center" >&nbsp;</td>
    </tr>
  </tbody>
...
<td colspan="5">
<p style="height:250px;">In order to upload your artwork you must complete the line e.g. File name and the number of sheets required. Upon which the file will be uploaded.</p>
</td>
</tr>
