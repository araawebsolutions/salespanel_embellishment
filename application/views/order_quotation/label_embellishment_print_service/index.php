...
if ($this->session->userdata('userid')) {
    $user_email = $this->orderModal->get_db_column('customers', 'UserEmail', 'UserID', $this->session->userdata('UserID'));
...
<div class="printedBg">
    <div class="container">
        ...
        <div class="row" id="bg-step-1" style="display:block;">
            ...
            <div class="col-sm-7 m-t-10" style="margin-top: 100px">
...
<script>
    ...
    $(document).on("click", ".layout_specs", function (e) {
        ...
        $.ajax({
            url: mainUrl + 'ajax/layout_popup/' + id,
            type: "POST",
            async: "false",
            dataType: "html",
            success: function (data) {
    ...
    function calculate_sheet_price(id, menuid) {
        ...
        if (!is_numeric(qty) || qty == '' || qty < min_qty) {
            ...
            $.ajax({
                url: mainUrl + 'ajax/calculate_printing_prices',
                type: "POST",
                async: "false",
                dataType: "html",
                data: {
    ...
    function filter_material_data(trigger, container, type) {
        ...
        show_loader('100', '27');
        var request = $.ajax({
            url: mainUrl + 'ajax/material_printingmaterials',
            type: "POST",
            async: "false",
            dataType: "html",
            data: {
    ...
    function update_material_selection(container) {
        ...
        $.ajax({
            url: mainUrl + 'ajax/update_printing_options',
            type: "POST",
            async: "false",
            data: {
                container: container,
    ...
    $(document).on("click", ".filter_search_handler", function (e) {
        ...
        show_loader('73', '25');
        $.ajax({
            url: mainUrl + 'ajax/search_printed_dies',
            type: "POST",
            async: "false",
            dataType: "html",
            data: {diecode: value},
    ...
    function filter_size_data(trigger) {
        ...
        if (shape.length < 1) {
            ...
            show_loader('73', '25');
            var request = $.ajax({
                url: mainUrl + 'ajax/printingfilters',
                type: "POST",
                async: "false",
                dataType: "html",
                data: {
...
*/
    ...
    function upload_printing_artworks(form_data) {
        $.ajax({
            url: mainUrl + 'ajax/material_upload_printing_artworks',
            type: "POST",
            async: "false",
            dataType: "html",
            cache: false,
    ...
    $(document).on("click", ".roll_updater,.sheet_updater", function (event) {
        ...
        $.ajax({
            url: mainUrl + 'ajax/material_update_printing_artworks',
            type: "POST",
            async: "false",
            dataType: "html",
            data: {
    ...
    $(document).on("click", ".delete_artwork_file", function (event) {
        ...
        swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    $.ajax({
                        url: mainUrl + 'ajax/delete_printing_artworks',
                        type: "POST",
                        async: "false",
                        dataType: "html",
                        data: {
    ...
    function update_additional_designs(designs) {
        ...
        if (designs > 0 || designs == 'nodesign') {
            ...
            $.ajax({
                url: mainUrl + 'ajax/update_additional_designs',
                type: "POST",
                async: "false",
                dataType: "html",
                data: {
    ...
    function update_cart_with_upload() {
        ...
        show_loader('80', '27');
        $.ajax({
            url: mainUrl + 'ajax/material_update_cart_with_upload',
            type: "POST",
            async: "false",
            dataType: "html",
            data: {
    ...
    function add_to_car_product() {
        ...
        show_loader('80', '27');
        $.ajax({
            url: mainUrl + 'ajax/add_printing_tocart',
            type: "POST",
            async: "false",
            dataType: "html",
            cache: false,
    ...
    function reset_preferences(email) {
        $.ajax({
            url: mainUrl + 'ajax/reset_preferences',
            type: "POST",
            async: "false",
            dataType: "html",
            data: {
    ...
    $(document).ready(function (e) {
        ...
        $("#email").focusout(function () {
            if (testEmail.test($("#email").val())) {
                ...
                $.post(mainUrl + 'ajax/add_email_to_session', {email: $("#email").val()});
    ...
    function pre_load_get_actual_products(allPreferences) {
        ...
        $.ajax({
            url: mainUrl + 'ajax/material_getfinalproducts',
            type: "POST",
            async: "false",
            dataType: "html",
            data: {
    ...
    function pre_load_add_item(allPreferences) {
        ...
        var max_qty = parseInt($('#max_qty' + id).val());
            ...
            $.ajax({
                url: mainUrl + 'ajax/material_continue_with_product',
                type: "POST",
                async: "false",
                dataType: "html",
                data: {
