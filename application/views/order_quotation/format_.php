<div id="aa_loader" class="white-screen" style="display:none ;position: absolute;z-index: 1;left: 0;right: 0;">
    <div class="loading-gif text-center" style="z-index: 1;padding-top: 7%;">
		<img src="https://www.aalabels.com/theme/site/images/loader.gif" class="image" style="width:160px; height:43px; ">
	</div>
</div>
                            ...
                            <div class="ThermalPrinterMain thermaloptions">
                              ...
                              <label for="A5" class="ProductThumbnail">
                                ...
                                <div class="ProductThumbnailImg">
                                 <img src="https://www.aalabels.com/theme/site/labelfinder/img/A5E048.png" class="img-responsive" alt="A5 Sheets" style="width:75px;"></div>
                        ...
                        <div class="col-md-12 SectionThreeMain">
							...
							<div class="col-md-1 button_column">
								...
								<div class="button_triggers">
									<a href="javascript:void(0);" data-val="labels_by_size" class="labels_by_size btn_trigger" data-role="button" style="display:none;">
										<img style="margin: 0 auto;" src="<?=Assets?>images/finder/label-by-size-new.png" class="img-responsive"/>
										<span class="trigger_label">Filter by Label Size</span>
									</a>
									<a href="javascript:void(0);" data-val="labels_per_sheet" class="labels_per_sheet btn_trigger" data-role="button">
										<img style="margin: 0 auto;" src="<?=Assets?>images/finder/label-per-sheet-new.png" class="img-responsive"/>
                                ...
                                <div class="LabelHeightMain" id="height_box">
									...
									<div class="WidthHightCheckbox">
										<label class="check" style="position:inherit !important;">
											...
											<input type="checkbox" checked="checked" name="opposite_dimension" id="opposite_dimension"> <span class="checkmark" style="    margin-left: 13px;"></span> </label>
									</div>
                            ...
                            <div class="col-md-3 pull-right">
								...
								<div class="row">
                                    <div class="col-md-12">
                                        <div class="template_search  template_search_new input-group" style="margin-left: 15px; width: 96%;">
