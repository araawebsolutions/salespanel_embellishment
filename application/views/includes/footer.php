...
<script src="<?= ASSETS ?>assets/js/datatable/js/jquery.dataTables.min.js"></script>
<script src="<?= ASSETS ?>assets/js/datatable/js/dataTables.bootstrap4.min.js"></script>
<!-- Responsive examples -->
<!--<script src="<?= ASSETS ?>assets/js/datatable/js/dataTables.responsive.min.js"></script>
<script src="<?= ASSETS ?>assets/js/datatable/js/responsive.bootstrap4.min.js"></script>-->
...
<link href="<?= ASSETS ?>assets/css/timepicker.css" rel="stylesheet" type="text/css"/>
<script src="<?= ASSETS ?>assets/js/bootstrap-timepicker.js"></script>
