...
?>
<td class="text-left invoicetable_description_loop invoicetable_tabel_border" style=" <?=(isset($print_style) and $print_style!='')?$print_style:''?>">
    ...
    if(isset($showartowrks) and $showartowrks =='Yes' and $AccountDetail->Printing=='Y'){
        $artowrks = $this->quoteModel->get_printed_files($AccountDetail->SerialNumber); ?>
        <? if(count($artowrks) > 0){
            ?>
            <div>
            <hr />
