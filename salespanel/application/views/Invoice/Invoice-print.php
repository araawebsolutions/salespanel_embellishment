...
<table width="750px" border="0" cellspacing="10" style="margin-left:-5px;">
    <tr>
        <td width="30%">
            ...
            <? }else{?>
                <img src="https://www.aalabels.com/theme/site/images/logo.png" border="0" width="160" height="66" />
            <? } ?>
        </td>
        <td width="30%">&nbsp;</td>
        ...
        <td colspan="3" align="left" valign="top" style="border:#CCCCCC 1px solid; padding-bottom:10px;"><table width="1043px" border="0" cellspacing="0" cellpadding="0">
                ...
                for($i=0;$i<count($OrderDetails);$i++)
                {
                    ...
                    else
                    {
                        ...
                        $ManufactureID= $this->orderModal->manufactureid("",$OrderDetails[$i]->ProductID);
                        $productName=$OrderDetails[$i]->ProductName;
                        $Price=$OrderDetails[$i]->Price;
                        $Quantity=$OrderDetails[$i]->Quantity;
                    ...
                    if($OrderDetails[$i]->Quantity!=0)
                    {
                        ...
                        $Order = (isset($OrderInfo[0]->currency) && $OrderInfo[0]->currency!='')?$OrderInfo[0]->currency:'GBP';
                        ...
                        <tr>
                            ...
                            <td class="invoicetable_description_loop">
                                <?php $productname =  $this->orderModal->ReplaceHtmlToString_($OrderDetails[$i]->ProductName); echo $productname; ?>

                                <?php
                                if($ManufactureID=="SCO1"){
                                    $custominfo = $this->orderModal->fetch_custom_die_order($OrderDetails[$i]->SerialNumber);
                                    ?>
                        ...
                        <tr <?=$stylo?>>
                            ...
                            <td class="invoicetable_Qty_loop">
                        ...
                        if($ManufactureID=="PRL1"){
                            $result = $this->orderModal->get_details_roll_quotation($OrderDetails[$i]->Prl_id);
                        }else{
                ...
                <? if($discount > 0){?>
                    <tr>
                        ...
                        <td class="invuice_subtotal_price"><? echo $symbol."".(number_format($discount*$exchange_rate,2));?></td>
                    </tr>
                <? } ?>

                <tr>
                    <td colspan="2">&nbsp;</td>
                    <td colspan="2"  class="invuice_subtotal">Sub total:</td>
                    <td class="invuice_subtotal_price">
                        <?php
                        if($OrderInfo[0]->PaymentMethods=='SampleOrder'){
                            $SubTotal ='0.00';
                ...
                <tr>
                    <td colspan="2">&nbsp;</td>
                    <td colspan="2" class="invuice_subtotal"><b>Grand Total:</b></td>
