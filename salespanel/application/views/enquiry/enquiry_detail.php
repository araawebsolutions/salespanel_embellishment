...
<?php if ($EnquiryDetail->RequestStatus != '13') { ?>
                                        <a href="#"
                                           ...
                                           data-toggle="modal" data-target="#myModal" style="margin-right: 22px;height: 35px;padding-top: 5px;padding-right: 0px;padding-left: 0px;">Edit</a>
                                           <?}?>
                            ...
                            <div class="card enquiry-card m-b-15">
                                ...
                                <div class="card-body" style="margin: 0px auto;">
                                    ...
                                    <?php if (@$EnquiryDetail->image) { ?>
                                        <a href="<?= aalables_path_material ?>integrated_attach/<?= $EnquiryDetail->image ?>">
                                            <img src="<?= aalables_path_material ?>integrated_attach/<?= $EnquiryDetail->image ?>"
...
<?php if ($EnquiryDetail->RequestStatus != '13') { ?>
                                             <div style="float: right;display: inline-flex;">
                                                    ...
                                                    <button style="height: 35px;padding: .375rem 1.1rem;" type="button" onclick="cancel_update('<?= $EnquiryDetail->QuoteNumber ?>');"
                                                            class="btn btn-outline-primary waves-light waves-effect width-select">
                                                       Cancel
                                                    </button>
                                                    </div>
                                                    <div style="width: 130px;margin-right: 43px;">
                                                    <button type="submit" style="height: 35px;padding: .375rem 1.1rem;" 
                                                            class="btn btn-pink waves-light waves-effect width-select ">
                                                        Update
                                                    </button>
                                                    </div>
                                                </div>
