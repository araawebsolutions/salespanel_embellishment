    ...
    <div class="tab-pane show active" id="home1">
        <div class="card-box no-padding">
            ...
            <tr id="line<?= $key ?>">
              ...
              <td id="checkout_unit_price<?= $key ?>"><?=$symbol ?><?= number_format($record->UnitPrice * $exchange_rate, 2) ?></td>
              <td><?= $record->Quantity ?></td>
              <td id="checkout_price<?= $key ?>"><?=$symbol ?><?= number_format($record->TotalPrice * $exchange_rate, 2) ?></td>
            </tr>
            <?php if ($record->Printing == 'Y' && $digitalCheck != 'roll') { ?>
            <tr>
              <td></td>
              <td></td>
              <td></td>
              <td></td>
              <td><?= $record->Print_Qty ?></td>
...
<div>
  <form method="post" id="checkout_form" class="labels-form " enctype="multipart/form-data"
      ...
      <div>
        ...
        <div class="row">
          <div class="col-sm-4 special-col-sm-4">
            		...
            		<input type="checkbox" name="plain_labels" class="textOrange" value="0" id="plain_labels">
    ...
    <div class="setup-content" id="step-3" style="display: none">
      ...
      <div class="row" style="margin-top: 20px;">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3 float-right">
          ...
          <button type="button" id="activate-step-4"
                        class="btn btn-outline-primary waves-light waves-effect width-select " style="padding: 7px;"> Review & Pay <i class="fa fa-arrow-circle-right"></i></button>
          <?php }?>
        </div>
      </div>
    </div>
    <div class="setup-content" id="step-4" style="display:none ;">
            ...
            <div class="m-t-10">
              <label class="radio borderRadius " style="margin-bottom: 10px !important;">
                <input type="radio" class="payment_for_ord" id="worldpay" value="creditCard"
                                   name="paymentway">
                <i class="rounded-x m-l-10"></i> <img style="float:right;"
      ...
      <br>
      <div class="col-md-3">
        <button type="button" id="shping" style="padding: 7px;border: 1px solid;border-radius: 4px;"
                    class="btn-outline-info waves-light waves-effect width-select "><i
                        class="fa fa-arrow-circle-left"></i> Shipping </button>
