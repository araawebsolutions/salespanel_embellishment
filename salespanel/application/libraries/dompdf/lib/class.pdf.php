...
//      }
   ...
   *    where the diffference between 'square' and 'butt' is that 'square' projects a flat en past the
   *    en of the line.
  ...
  function stream($options = '') {
    ...
    //        work as in my trial the browser seems to use the filename of the php file with .pdf on the en
   ...
   * on the page the text will en
   */
  private function getTextPosition($x, $y, $angle, $size, $wa, $text) {
    // given this information return an array containing x and y for the en position as elements 0 and 1
  ...
  function addText($x, $y, $size, $text, $angle = 0, $wordSpaceAdjust = 0, $charSpaceAdjust = 0, $smallCaps = false) {
    ...
    // if there are any open callbacks, then they should be called, to show the en of the line
    if ($this->nCallback > 0) {
      for ($i = $this->nCallback; $i > 0; $i--) {
        // call each function
   ...
   * en of the previous page, before the stack was closed down
