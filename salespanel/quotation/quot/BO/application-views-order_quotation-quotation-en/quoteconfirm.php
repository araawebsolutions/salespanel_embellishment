...
<tr>  
 ...
 <td width="50%" border="0" cellspacing="0" cellpadding="0" align="left" valign="middel" >
  ...
  <tr>
    ...
    <td class="invoicetable_tabel_border" width="380px">
    ...
    <td align="center" class="invoicetable_tabel_border">
      <?php
      if($prodinfo['ProductBrand'] != 'Roll Labels' && $AccountDetail->ProductID != '0'){
                                  echo $AccountDetail->Quantity * $LabelsPerSheet.'<br>';
                                 }else {
                                    echo $AccountDetail->orignalQty.'<br>';      
                                 }
                                  echo "Labels";
      ?> 
      <br>
    ...
    <?php if(preg_match('/Rolls/',$AccountDetail->ProductName)){
      echo "Rolls";
    }else{
  ...
  ?>  
    ...
    <td class="invoicetable_tabel_border" align="center">
      ...
      <?php echo $AccountDetail->Print_Qty; ?>&nbsp; Design
      <br>
      <?php if(preg_match('/Sheet/',$AccountDetail->ProductName)){?>
      
      (<?php echo $AccountDetail->Free; ?>&nbsp; Design Free)
    ...
    <td class="invoicetable_tabel_border" align="center">
      ...
      <?php 
        ...
        include(APPPATH . 'views/old_pdf_views/pp_line.php');
...
<tr>
<td width="100%"> <img style="margin-left:5px;" src="<?=base_url()?>aalabels/img/green-tick.png" width="12" height="12"/>
       &nbsp; <span style="margin-top:5px;">Lowest Prices Guaranteed Online </span></td>
</tr>
</table>  
...
<div class="footer">
<img alt="AA Labels" src="https://www.aalabels.com/theme/site/images/price-promise-back.png">
<br />
